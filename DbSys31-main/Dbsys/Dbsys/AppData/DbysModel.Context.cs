...
public partial class DBSYSEntities : DbContext
{
    ...
    public virtual int sp_CreateUser(string userName, string userPassword, Nullable<int> role, string userStatus, Nullable<int> createdBy)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_CreateUser1", userNameParameter, userPasswordParameter, roleParameter, userStatusParameter, createdByParameter);
    }
